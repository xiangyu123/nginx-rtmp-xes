...
static u_char ngx_rtmp_mpegts_pat_header[] = {
...
static u_char ngx_rtmp_mpegts_pmt_av_header[] = {
    ...
    /* PMT */
    0xe1, 0x00,//111:0 0001 0000 0000  pcr stream
    0xf0, 0x00,//1111 0000 0000 0000  resrved, program_info_length
...
static u_char ngx_rtmp_mpegts_pmt_v_header[] = {
    ...
    /*0x03, 0xe1, 0x01, 0xf0, 0x00,*/ /* mp3 */
    /* CRC */
    0x15, 0xbd, 0x4d, 0x56, /* crc for aac */
    /*0x4e, 0x59, 0x3d, 0x1e,*/ /* crc for mp3 */
...
static u_char ngx_rtmp_mpegts_pmt_a_header[] = {
    ...
    0x02, 0xb0, 0x12, 0x00, 0x01, 0xc1, 0x00, 0x00,
    /* PMT */
    0xe1, 0x01,//111:0 0001 0000 0000  pcr stream
    0xf0, 0x00,//1111 0000 0000 0000  resrved, program_info_length
    /*0x1b, 0xe1, 0x00, 0xf0, 0x00, *//* h264 */
    0x0f, 0xe1, 0x01, 0xf0, 0x00, /* aac */
    /*0x03, 0xe1, 0x01, 0xf0, 0x00,*/ /* mp3 */
    /* CRC */
    0xec, 0xe2, 0xb0, 0x94, /* crc for aac */
    /*0x4e, 0x59, 0x3d, 0x1e,*/ /* crc for mp3 */
    /* stuffing 157 + 5 bytes */
    0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
ngx_int_t
ngx_rtmp_mpegts_write_header(ngx_file_t *file, e_header_type etype)
{
    ssize_t rc;

    rc = ngx_write_file(file, ngx_rtmp_mpegts_pat_header,
                        sizeof(ngx_rtmp_mpegts_pat_header), 0);

    if (rc > 0) {
        if (etype == H_AV) {
            rc = ngx_write_file(file, ngx_rtmp_mpegts_pmt_av_header,
                            sizeof(ngx_rtmp_mpegts_pmt_av_header), sizeof(ngx_rtmp_mpegts_pat_header));
        }
        else if (etype == H_VID) {
            rc = ngx_write_file(file, ngx_rtmp_mpegts_pmt_v_header,
                            sizeof(ngx_rtmp_mpegts_pmt_v_header), sizeof(ngx_rtmp_mpegts_pat_header));
        }
        else{
            rc = ngx_write_file(file, ngx_rtmp_mpegts_pmt_a_header,
                            sizeof(ngx_rtmp_mpegts_pmt_a_header), sizeof(ngx_rtmp_mpegts_pat_header));
        }
    }
